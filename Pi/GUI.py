...
class MainApp(App):
    ...
    def update_labels(self, dt): #THIS IS THE IMPORTANT FUNCTION
        ...
        self.crew_screen.ids.dragon7_1.text = crew7count + " / " + str(dragon7_1)
        self.crew_screen.ids.dragon7_2.text = crew7count + " / " + str(dragon7_2)
        self.crew_screen.ids.dragon7_3.text = crew7count + " / " + str(dragon7_3)
        self.crew_screen.ids.dragon7_4.text = crew7count + " / " + str(dragon7_4)
...
#            LOSpopup.open()
        ...
        self.eclss_acs_screen.ids.LabPPN2.text = LabPPN2 + " mmHg  " + "(" + "{:.0f}".format((float(LabPPN2)/totalLabAtmo)*100) + ")" + "%"
        self.eclss_acs_screen.ids.LabPPO2.text = LabPPO2 + " mmHg  " + "(" + "{:.0f}".format((float(LabPPO2)/totalLabAtmo)*100) + ")" + "%"
        self.eclss_acs_screen.ids.LabPPCO2.text = LabPPCO2 + " mmHg  " + "(" + "{:.0f}".format((float(LabPPCO2)/totalLabAtmo)*100) + ")" + "%"
        self.eclss_acs_screen.ids.N3PPN2.text = N3PPN2 + " mmHg  " + "(" + "{:.0f}".format((float(N3PPN2)/totalN3Atmo)*100) + ")" + "%"
        self.eclss_acs_screen.ids.N3PPO2.text = N3PPO2 + " mmHg  " + "(" + "{:.0f}".format((float(N3PPO2)/totalN3Atmo)*100) + ")" + "%"
        self.eclss_acs_screen.ids.N3PPCO2.text = N3PPCO2 + " mmHg  " + "(" + "{:.0f}".format((float(N3PPCO2)/totalN3Atmo)*100) + ")" + "%"
