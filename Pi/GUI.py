...
#            LOSpopup.open()
        ...
        self.orbit_data.ids.position_x.text = str(position_x)
        self.orbit_data.ids.position_y.text = str(position_y)
        self.orbit_data.ids.position_z.text = str(position_z)
        self.orbit_data.ids.velocity_x.text = str(velocity_x)
        self.orbit_data.ids.velocity_y.text = str(velocity_y)
        self.orbit_data.ids.velocity_z.text = str(velocity_z)
