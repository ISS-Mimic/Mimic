...
class MainApp(App):
    ...
    def update_labels(self, dt): #THIS IS THE IMPORTANT FUNCTION
        ...
        LTwater_Lab = "{:.1f}".format(float((values[192])[0]))
        MTwater_Lab = "{:.1f}".format(float((values[193])[0]))
        ...
        LTwater_Node2 = "{:.1f}".format(float((values[82])[0]))
        MTwater_Node2 = "{:.1f}".format(float((values[81])[0]))
        AC_Node2 = str((values[83])[0])
        FluidTempAir_Node2 = "{:.2f}".format(float((values[84])[0]))
        FluidTempAv_Node2 = "{:.2f}".format(float((values[85])[0]))
        LTwater_Node3 = "{:.1f}".format(float((values[101])[0]))           #These two could be switched
        MTwater_Node3 = "{:.1f}".format(float((values[99])[0]))            #These two could be switched
