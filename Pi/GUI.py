...
class MainApp(App):
    ...
    def update_labels(self, dt): #THIS IS THE IMPORTANT FUNCTION
        ...
        self.crew_screen.ids.dragon7_2.text = dragon7count + " / " + str(dragon7_2)
        self.crew_screen.ids.dragon7_3.text = dragon7count + " / " + str(dragon7_3)
        self.crew_screen.ids.dragon7_4.text = dragon7count + " / " + str(dragon7_4)
