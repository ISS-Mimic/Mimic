    ...
    def _build_serial_command(self, telemetry_values):
        ...
        try:
            ...
            serial_cmd = (
                ...
                f"V4B={v4bs:.1f} "
                f"ISS={module:.1f} "
                f"Sgnt_el={sgant_elevation:.1f} "
                f"Sgnt_xel={sgant_xelevation:.1f} "
                f"Sgnt_xmit={sgant_transmit:.1f} "
                f"SASA_Xmit={sasa_xmit:.1f} "
                f"SASA_AZ={sasa_az:.1f} "
                f"SASA_EL={sasa_el:.1f} "
            )
