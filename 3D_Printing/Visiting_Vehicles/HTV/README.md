...
# HTV-ISS Mimic Print Profile

![image](https://github.com/user-attachments/assets/da0f5923-c21b-43d2-96e0-75e6ece0a634)

Recommend a white PLA for printing if you plan to paint it. The vehicle is mostly like a copper color. 

Most settings are default, really just need tree supports on build plate only. Might be better to print upside down, either way one surface will be rough. The end thrusters are very easy to break while removing supports. 
