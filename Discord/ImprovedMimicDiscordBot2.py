...
class MainListener:
    ...
    def onItemUpdate(self, update):
        ...
        elif item_name == "USLAB000039": #ISS mass
            mass_diff = value - old_iss_mass
            old_iss_mass = value
            print("iss mass")
            send_message("**ISS Mass Change Alert**", f"The ISS Reported Mass is now **{value:.2f}** kilograms!")
            send_message("**ISS Mass Change Alert**", f"difference: **{mass_diff}**")
