...
double SGANT_El_deg = -30; // SGANT antenna elevation angle, deg; From telemetry stream
double SGANT_xEl_deg = 30; // SGANT "cross elevation" angle, deg; From telemetry stream
...
AccelStepper stepper1(FULLSTEP, StepA1, StepC1, StepB1, StepD1);
AccelStepper stepper2(FULLSTEP, StepA2, StepC2, StepB2, StepD2);
