...
// ======== B2B PID Vals=====================
//  PID Constants
float Kp_B2B = 10; // Proportional Gain of PID
float Ki_B2B = 1; // Integral Gain of PID
float Kd_B2B = 2; // Derivative Gain of PID
...
// ======== B4B PID Vals=====================
//  PID Constants
float Kp_B4B = 10; // Proportional Gain of PID
float Ki_B4B = 1; // Integral Gain of PID
float Kd_B4B = 2; // Derivative Gain of PID
...
// ======== B2A PID Vals=====================
//  PID Constants
float Kp_B2A = 10; // Proportional Gain of PID
float Ki_B2A = 1; // Integral Gain of PID
...
// ======== B4A PID Vals=====================
//  PID Constants
float Kp_B4A = 10; // Proportional Gain of PID
float Ki_B4A = 1; // Integral Gain of PID
float Kd_B4A = 2; // Derivative Gain of PID
