...
// ======== B1B PID Vals=====================
//  PID Constants
float Kp_B1B = 10; // Proportional Gain of PID
float Ki_B1B = 1; // Integral Gain of PID
float Kd_B1B = 2; // Derivative Gain of PID
...
// ======== B3B PID Vals=====================
//  PID Constants
float Kp_B3B = 10; // Proportional Gain of PID
float Ki_B3B = 1; // Integral Gain of PID
float Kd_B3B = 2; // Derivative Gain of PID
...
// ======== B1A PID Vals=====================
//  PID Constants
float Kp_B1A = 10; // Proportional Gain of PID
float Ki_B1A = 1; // Integral Gain of PID
float Kd_B1A = 2; // Derivative Gain of PID
...
// ======== B3A PID Vals=====================
//  PID Constants
float Kp_B3A = 10; // Proportional Gain of PID
float Ki_B3A = 1; // Integral Gain of PID
float Kd_B3A = 2; // Derivative Gain of PID
...
float Ki_PSARJ = 1; // Integral Gain of PID
float Kd_PSARJ = 8; // Derivative Gain of PID
