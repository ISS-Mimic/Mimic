...
//    }
    else if (test2.substring(0, delimeter) == "Beta2B") // BCM lies to get stbd going, June 7, 2019; Unmapped July 1, 2019
    {
      B2B = (test2.substring(delimeter + 1)).toFloat();
    }
    else if (test2.substring(0, delimeter) == "Beta2A") // BCM lies to get stbd going, June 7, 2019; Unmapped July 1, 2019
    {
...
//    }
    else if (test2.substring(0, delimeter) == "Beta4B")// BCM lies to get stbd going, June 7, 2019; Unmapped July 1, 2019
    {
      B4B = (test2.substring(delimeter + 1)).toFloat();
    }
    else if (test2.substring(0, delimeter) == "Beta4A") // BCM lies to get stbd going, June 7, 2019; Unmapped July 1, 2019
    {
