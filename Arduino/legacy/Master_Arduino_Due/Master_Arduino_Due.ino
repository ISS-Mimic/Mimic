...
int MyHighPin = 53; // This is just to have a convenient 3.3volt source near the other utilized pins
...
void setup() {
 pinMode(MyHighPin, OUTPUT);   
 digitalWrite(MyHighPin, HIGH); // This is just a convenient pin for 3.3 volts

  // Attach a servo to pin #10
  servo1.attach(10);
  AFMS.begin(500);  // I set this at 200 previously to reduce audible buzz.
  Serial.begin(115200);
